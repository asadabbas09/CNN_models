...
num_train = 28709
num_val = 3589
train_data_file_default = 'train_csv2.csv'
val_data_file_default = 'valid_csv.csv'
...
cnn = CNN()
print(DEFAULT_USE_BATCHNORM)
cnn.load_data(train_data_file_default, val_data_file_default, num_train=num_train, num_val=num_val)
caption = ("LR: " + str(DEFAULT_LR) 
    + ", Dropout1: " + str(DEFAULT_DROPOUT1)  
    + ", Dropout2: " + str(DEFAULT_DROPOUT2) 
    + ", BN: " + str(DEFAULT_USE_BATCHNORM) 
    + ",\nFS 1: " + str(DEFAULT_LAYER_SIZE_1) 
    + ", FS 2: " + str(DEFAULT_LAYER_SIZE_2) 
    + ", Depth1: " + str(DEFAULT_DEPTH1) 
    + ", Depth2: " + str(DEFAULT_DEPTH2)
    + ", Reg L2 = " + str(DEFAULT_REG) )
